...
public class SimulationService {
    ...
    public void simulateSensorData() {
        ...
        for (Asset asset : assets) {
            ...
            SensorReading newSensorReading = new SensorReading(asset, newTemperature, newPressure, LocalDateTime.now());

            sensorService.saveReading(newSensorReading);

            System.out.println("simulated sensor data for asset: " + asset);
        }
